# Generated by Django 4.2.10 on 2024-02-18 19:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bcc', models.ManyToManyField(blank=True, related_name='bcc_emails', to=settings.AUTH_USER_MODEL)),
                ('cc', models.ManyToManyField(blank=True, related_name='cc_emails', to=settings.AUTH_USER_MODEL)),
                ('recipient', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='received_emails', to=settings.AUTH_USER_MODEL)),
